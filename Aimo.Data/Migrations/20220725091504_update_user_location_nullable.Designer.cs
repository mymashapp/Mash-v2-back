...
namespace Aimo.Data.Migrations
{
    ...
    [Migration("20220725091504_update_user_location_nullable")]
    partial class update_user_location_nullable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aimo.Domain.Chats.Chat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Aimo.Domain.Chats.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Aimo.Domain.Chats.ChatUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Aimo.Domain.ScheduleTasks.ScheduleTask", b =>
                {
                    ...
                    b.Property<double>("IntervalInSeconds")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Aimo.Domain.SwipeHistories.SwipeGroupInterest", b =>
                {
            ...
            modelBuilder.Entity("Aimo.Domain.SwipeHistories.SwipeHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Aimo.Domain.SwipeHistories.SwipeGroupInterest", b =>
                {
                    ...
                    b.HasOne("Aimo.Domain.SwipeHistories.SwipeGroup", "SwipeGroup")
                        .WithMany()
